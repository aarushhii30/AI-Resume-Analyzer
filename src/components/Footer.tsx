        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 text-center sm:text-left">
          ...
          <div className="col-span-1 sm:col-span-2">
            <div className="mb-4 sm:mb-6">
              <span className="font-bold text-xl sm:text-2xl text-slate-900">AI Resume Analyzer</span>
            </div>
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a 
                ...
                className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 hover:bg-indigo-100 hover:text-indigo-600 transition-colors"
                aria-label="Twitter"
              >
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <Link to="/analyze" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>Resume Analysis</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <Link to="/builder" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>Resume Builder</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <Link to="/job-match" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>Job Matching</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <Link to="/pricing" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>Pricing</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li>
                <Link to="/about" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>About Us</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
                  <span>Contact</span>
                  <ArrowUpRight size={12} className="sm:size-[14px] ml-1 transition-transform group-hover:translate-x-1" />
                </Link>
              </li>
              <li>
                <a href="mailto:support@aicareerforge.com" className="text-sm sm:text-base text-slate-600 hover:text-indigo-600 transition-colors inline-flex items-center group">
