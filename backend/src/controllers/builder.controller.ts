...
// const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash-lite" }); // Old model

const model = genAI.getGenerativeModel({ model: "gemini-2.0-flash-lite" }); // Use current recommended model
